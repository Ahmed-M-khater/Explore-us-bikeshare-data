...
def get_filters():
    ...
    """
    print('\nHello! this is  US bikeshare data!\n')
...
def load_data(city, month, day):
    ...
    #convert 'start Time' to datetime object to get the time of trip
...
def station_stats(df):
    ...
    # display most commonly used start station by the customer 
    print('The most common Start Station is: {}'.format(most_common_start_station))
    # display most commonly used end station by the user
...
def trip_duration_stats(df):
    ...
    start_time = time.time()
    # Show total travel time for a trip 
...
def user_stats(df):
    ...
    # Display counts of user types (subscriber or customer )
    
    user_types = df['User Type'].value_counts()
    
    print("Count of user types:\n{0}\n{1}\n{0}\n".format('-'*20,user_types.to_string()))
    
    # Display counts of gender (Male / Femal )
    ...
    if 'Gender' in df:
       ...
       print("No Gender data to display for chosen city")     
